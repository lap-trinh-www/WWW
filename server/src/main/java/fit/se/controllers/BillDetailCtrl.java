...
// })
// public ResponseEntity<ResponeMessage> addRoom(@RequestBody BillDetail
// billDetail) {
...
// @GetMapping("/{billId}")
// public ResponseEntity<ResponeMessage> getRoomById(@PathVariable String
// billId) {
// try {
// List<BillDetailDTO> billDetailDTOs =
// billDetailService.getBillDetailByBillId(billId);

// return ResponseEntity.status(HttpStatus.OK).body(new ResponeMessage("ok",
// "success", billDetailDTOs));
// } catch (Exception e) {
// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
// .body(new ResponeMessage("error", "Not found", e.getMessage()));
// }
