...
// return
// billDetailRepository.findAll().stream().map(this::convertEntityToDTO).collect(Collectors.toList());
// }
...
// billDetailRepository.getBillDetail(newBillDetail.getBills().getBill_ID(),
// newBillDetail.getRooms().getRoom_ID());
// if (billDetail != null) {
